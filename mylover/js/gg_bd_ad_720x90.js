...
//document.writeln("<script type="\"text/javascript\"");" document.writeln("src="\"http://pagead2.googlesyndication.com/pagead/show_ads.js\"">");
//document.writeln("</script></div>");

//document.writeln("<div style="\"width:728px;margin:10px" auto;\">")
//document.writeln('<script async src="//pagead2.googlesyndication.com/pagead/js/adsbygoogle.js"></script>');
//document.writeln('<!-- 评道demo横幅 -->');
//document.writeln('<ins class="adsbygoogle" '); document.writeln(' style="display:inline-block;width:728px;height:90px" data-ad-client="ca-pub-3171310320403916" data-ad-slot="5686750586"></ins>');
//document.writeln('<script>');
...
//document.writeln('<ins class="adsbygoogle" '); document.writeln(' style="display:inline-block;width:728px;height:90px" data-ad-client="ca-pub-4188263447419139" data-ad-slot="1639624407"></ins>');
//document.writeln('<script>');
//document.writeln('(adsbygoogle = window.adsbygoogle || []).push({});');
//document.writeln('</script>');
//document.writeln("</div>");
...
document.writeln('<ins class="adsbygoogle" '); document.writeln(' style="display:inline-block;width:970px;height:250px" data-ad-client="ca-pub-4188263447419139" data-ad-slot="5506515209"></ins>');
document.writeln('<script>');
document.writeln('(adsbygoogle = window.adsbygoogle || []).push({});');
document.writeln('</script>');
document.writeln("</div>");
...
//document.writeln('<ins class="adsbygoogle" '); document.writeln(' style="display:inline-block;width:336px;height:280px" data-ad-client="ca-pub-3171310320403916" data-ad-slot="2263352181"></ins>');
//document.writeln('<script>');
//document.writeln('(adsbygoogle = window.adsbygoogle || []).push({});');
//document.writeln('</script>');
//document.writeln("</div>");
